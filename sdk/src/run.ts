...
async function runOnce({
  ...
  // Skip server-side auth check when a custom model endpoint is configured.
  // In this case the agent uses the user's own API endpoint instead of the
  // Codebuff backend, so no Codebuff account is needed.
