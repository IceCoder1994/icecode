...
describe('env-ci', () => {
  describe('getCiEnv', () => {
    ...
    test('returns current process.env values for ICECODE_GITHUB_TOKEN', () => {
      process.env.ICECODE_GITHUB_TOKEN = 'ghp_test_token'
      const env = getCiEnv()
      expect(env.ICECODE_GITHUB_TOKEN).toBe('ghp_test_token')
    })
  ...
  describe('ciEnv', () => {
    ...
    test('contains expected keys', () => {
      ...
      expect('ICECODE_GITHUB_TOKEN' in ciEnv).toBe(true)
    })
  })
  ...
  describe('createTestCiEnv', () => {
    ...
    test('returns undefined for most vars by default', () => {
      ...
      expect(env.ICECODE_GITHUB_TOKEN).toBeUndefined()
    })
    ...
    test('allows setting all CI-related vars for CI simulation', () => {
      const env = createTestCiEnv({
        ...
        ICECODE_GITHUB_TOKEN: 'ghp_simulated_token',
      ...
      expect(env.ICECODE_GITHUB_TOKEN).toBe('ghp_simulated_token')
