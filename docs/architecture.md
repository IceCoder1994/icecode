...
Codebuff is a TypeScript monorepo (Bun workspaces) that provides an AI-powered coding assistant via a CLI and SDK.
...
A separate free-to-use version of Codebuff with its own CLI binary.
