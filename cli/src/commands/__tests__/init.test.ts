...
describe('handleInitializationFlowLocally', () => {
  ...
  beforeEach(() => {
    ...
    // Mock analytics to prevent client initialization errors
    trackEventSpy = spyOn(analytics, 'trackEvent').mockImplementation(() => {})
  ...
  describe('knowledge file creation', () => {
    ...
    test('skips AGENTS.md creation when it already exists', () => {
      ...
      // writeFileSync should not be called for AGENTS.md
  ...
  describe('error handling', () => {
    ...
    test('handles writeFileSync errors for AGENTS.md gracefully', () => {
      ...
      // The function should throw when AGENTS.md write fails
      // since AGENTS.md write is not wrapped in try-catch
