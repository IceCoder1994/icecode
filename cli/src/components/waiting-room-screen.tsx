...
import { useCustomModelStore } from '../state/custom-model-store'
...
export const WaitingRoomScreen: React.FC<WaitingRoomScreenProps> = ({
  ...
  // state: show the custom model config screen directly.
  ...
  // Premium quota counter for the title line. Only relevant for limited tier.
    ...
    >
      ...
      >
        ...
        >
          ...
          {isLanding && accessTier !== 'limited' && (
            <CustomModelManager onClose={() => {
              // No-op in embedded mode — the manager is the landing page.
            }} />
          )}
